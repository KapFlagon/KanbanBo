...
import domain.activerecords.FindableByUUID;
...
public abstract class AbstractProjectActiveRecord<T extends AbstractProjectBaseTable> extends AbstractActiveRecord implements FindableByUUID {
    ...
    public void deleteActiveRowInDb() throws SQLException, IOException {
        this.setupDbConnection();
        dao.deleteById(getProjectUUID());
        this.teardownDbConnection();
    }
