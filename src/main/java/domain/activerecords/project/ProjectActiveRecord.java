...
public class ProjectActiveRecord extends AbstractProjectActiveRecord {
    ...
    // Variables
    protected ProjectTable projectModel;
    ...
    public ProjectActiveRecord(ProjectTable projectModel) throws SQLException, IOException {
        super(ProjectTable.class, projectModel);
        this.projectModel = projectModel;
        this.initAllProperties();
        updateStatusText();
        this.setAllListeners();
    ...
    // Getters and Setters
    public void setProjectModel(ProjectTable projectModel) throws IOException, SQLException {
    ...
    protected void initAllProperties() {
        ...
        statusID = new SimpleIntegerProperty(projectModel.getProject_status_id());
    }
    ...
    private void setStatusChangeListener() {
        ChangeListener<Number> changeListener = new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                projectModel.setProject_status_id((Integer) newValue);
                try {
