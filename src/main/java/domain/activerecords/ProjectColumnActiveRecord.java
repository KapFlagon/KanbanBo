...
public class ProjectColumnActiveRecord<T extends ColumnTable> extends AbstractActiveRecord implements FindableByUUID{
    ...
    protected SimpleBooleanProperty finalColumn;
    ...
    public void setFinalColumn(boolean finalColumn) {
        this.finalColumn.set(finalColumn);
    }
    ...
    protected void initAllProperties() {
        ...
        this.finalColumn = new SimpleBooleanProperty(projectColumnModel.isFinal_column());
    }
