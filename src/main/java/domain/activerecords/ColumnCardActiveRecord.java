...
public class ColumnCardActiveRecord <T extends CardTable> extends AbstractActiveRecord implements FindableByUUID{
    ...
    public void setParentColumnActiveRecord(ProjectColumnActiveRecord<ColumnTable> parentColumnActiveRecord) throws IOException, SQLException {
        this.parentColumnActiveRecord = parentColumnActiveRecord;
    ...
    @Override
    public UUID getUUID() {
        return columnCardModel.getCard_uuid();
    }
}
