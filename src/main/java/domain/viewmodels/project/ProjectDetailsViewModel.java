...
public class ProjectDetailsViewModel {
    ...
    // Variables
    private ObservableWorkspaceProject project;
    ...
    public ProjectDetailsViewModel(ObservableWorkspaceProject project, ProjectStatusListViewModel projectStatusListViewModel) {
