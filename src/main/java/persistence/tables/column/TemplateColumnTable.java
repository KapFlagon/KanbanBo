...
public class TemplateColumnTable extends AbstractColumnBaseTable {
    ...
    @DatabaseField(canBeNull = true, useGetSet = true, dataType = DataType.BOOLEAN)
    private boolean final_column;


    // Constructors
    public TemplateColumnTable() {
